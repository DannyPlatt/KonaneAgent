/* Program: MiniMaxPlayer.cpp
 * Purpose: MiniMaxPlayer uses miniMax algorithm to determin best move
 * Author: Danny Platt
...
MiniMaxPlayer::MiniMaxPlayer(KonaneBoard board, char Player)
...
vector<int> MiniMaxPlayer::makeMove(KonaneBoard state) {
...
vector<int> MiniMaxPlayer::Decision(KonaneBoard state, int depth) {
...
int MiniMaxPlayer::maxVal(KonaneBoard state, int depth) {
...
int MiniMaxPlayer::minVal(KonaneBoard state, int depth) {
...
int MiniMaxPlayer::evaluate(KonaneBoard state, int multiplier) {
